...
<head>
  ...
  <title>View Architectural Design</title>
     ...
     <div class="container">
       ...
       <?php
         ...
         <div class="col-md-4 image">
           <a href="designDetails.php?id=<?php echo $result['architecture_id'] ?>">



            <img src="architectureimg/<?php echo $result['image_1']; ?>" style="width: 400px;" class="img-responsive"></a>
