                ...
                <li class="sidebar-item dropdown" data-toggle="collapse" data-target="#service" class="collapsed">
                 ...
                 <li class="sidebar-item">
                  <a href="#" class="sidebar-link waves-effect waves-dark sidebar-link">
                    ...
                    <span class="hide-menu"><i class="fa fa-shopping-cart"></i>  E commerce<span class="caret"></span></span>
                  </a>
                </li>
                <li class="sidebar-item dropdown" data-toggle="collapse" data-target="#service" class="collapsed">
                  <a href="" class="sidebar-link waves-effect waves-dark sidebar-link">
...
<?php
 if (isset($_POST['update'])) {
   ...
   if($img1 = '' || $img2=''||$img3=''){
       mysqli_query($con,"UPDATE `add_architecture` SET `title`='$title',`discription`='$discription',`plot_area`= $plot_area,`building_type`='$building_type',`building_style`='$building_style',`badroom`=$badroom,`bathroom`=$bathroom,`floor`=$floor,`kitchen`=$kitchen,`foundation_type`='$foundation_type',`price`=$price WHERE architecture_id = $id");
   }else{
    ...
    mysqli_query($con,"UPDATE `add_architecture` SET `image_1`='$image_1',`image_2`='$image_2',`image_3`='$image_3',`title`='$title',`discription`='$discription',`plot_area`= $plot_area,`building_type`='$building_type',`building_style`='$building_style',`badroom`=$badroom,`bathroom`=$bathroom,`floor`=$floor,`kitchen`=$kitchen,`foundation_type`='$foundation_type',`price`=$price WHERE architecture_id = $id");
...
<script type="text/javascript">
  window.location("showArchetecturalDesign.php");
</script>
